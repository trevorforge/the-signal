      ...
      {stories.length === 0 ? (
        ...
        <div className="space-y-2">
          {stories.map((story, i) => {
            ...
            const cardClass = "block bg-surface border border-border rounded-xl p-4 hover:border-signal-orange/40 transition-colors group";
            const cardContent = (
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <h2 className="font-display font-semibold text-sm text-text-primary group-hover:text-signal-orange transition-colors leading-snug">
                    {story.title}
                  </h2>
